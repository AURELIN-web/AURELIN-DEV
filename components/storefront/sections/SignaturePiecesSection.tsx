...
export default function SignaturePiecesSection({ title = "SIGNATURE PIECES", products, ctaText = "VIEW ALL", ctaUrl = "/shop" }: Props) {
  ...
  return (
    <section className="py-16 md:py-20" style={{ backgroundColor: "#F8F6F0" }}>
      <div className="container-luxury">
        {/* Section Header */}
        <div className="flex items-center justify-between mb-10 border-b pb-4" style={{ borderColor: "#D8C8AF40" }}>
          <div>
            <h2
              style={{
